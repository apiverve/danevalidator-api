# DANE Record Validator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:danevalidator-api:1.1.12'
}
```
...
```java
import com.apiverve.danevalidator.DANERecordValidatorAPIClient;
import com.apiverve.danevalidator.APIResponse;
import com.apiverve.danevalidator.APIException;

// Initialize the client
DANERecordValidatorAPIClient client = new DANERecordValidatorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/danevalidator](https://docs.apiverve.com/ref/danevalidator)
...
- **Documentation:** [https://docs.apiverve.com/ref/danevalidator](https://docs.apiverve.com/ref/danevalidator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/danevalidator-api/issues)
