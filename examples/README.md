# DANE Record Validator API - Examples

This folder contains example code for using the DANE Record Validator API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/danevalidator',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/danevalidator");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/danevalidator](https://docs.apiverve.com/ref/danevalidator)
