...
{
    class DANERecordValidatorExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/danevalidator";

        /// <summary>
        /// Make a POST request to the DANE Record Validator API
        /// </summary>
        static async Task<JsonDocument> CallDANERecordValidatorAPI()
        {
            try
            {
                ...
                // Request body
                var requestBody &#x3D; new { record &#x3D; &quot;_443._tcp.example.com. 86400 IN TLSA 3 1 1 0123456789ABCDEF0123456789ABCDEF0123456789ABCDEF0123456789ABCDEF&quot; };
        ...
        {
            Console.WriteLine("📤 Calling DANE Record Validator API...\n");

            var result = await CallDANERecordValidatorAPI();
