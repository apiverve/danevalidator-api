// Package danevalidator provides a Go client for the DANE Record Validator API.
//
// For more information, visit: https://apiverve.com/marketplace/danevalidator?utm_source=go&utm_medium=readme
package danevalidator
...
// Request contains the parameters for the DANE Record Validator API.
//
// Parameters:
//   - record (required): string - The DANE/TLSA record string to validate
type Request struct {
...
// ResponseData contains the data returned by the DANE Record Validator API.
...
type ParsedData struct {
	...
	CertificateDataLength int `json:"certificate_data_length"`
}

// InterpretationData represents the interpretation object.
type InterpretationData struct {
	Usage UsageData `json:"usage"`
	Selector SelectorData `json:"selector"`
	Matching MatchingData `json:"matching"`
	SecurityLevel string `json:"security_level"`
	Recommendation string `json:"recommendation"`
}

// UsageData represents the usage object.
...
// SelectorData represents the selector object.
...
// MatchingData represents the matching object.
...
// ValidationData represents the validation object.
type ValidationData struct {
	IsValid bool `json:"is_valid"`
	CertificateDataFormat string `json:"certificate_data_format"`
	CertificateDataLengthValid bool `json:"certificate_data_length_valid"`
}
