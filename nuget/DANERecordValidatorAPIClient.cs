...
namespace APIVerve.API.DANERecordValidator
{
    ...
    /// <summary>
    /// Client for the DANERecordValidator API
    /// </summary>
    public class DANERecordValidatorAPIClient
#if !NET20 && !NET35 && !NET40
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/danevalidator";
        ...
        public DANERecordValidatorAPIClient(string apiKey)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public DANERecordValidatorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public DANERecordValidatorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, DANERecordValidatorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(DANERecordValidatorQueryOptions options)
        {
        ...
        public ResponseObj Execute(DANERecordValidatorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(DANERecordValidatorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(DANERecordValidatorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(DANERecordValidatorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(DANERecordValidatorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(DANERecordValidatorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(DANERecordValidatorQueryOptions options)
        {
