...
namespace APIVerve\Danevalidator;
...
/**
 * Client for the DANE Record Validator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/danevalidator?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/danevalidator';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\DanevalidatorClient] {$message}\n";
        }
    }
}
