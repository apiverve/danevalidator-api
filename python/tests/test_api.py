...
class TestDanevalidatorAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = DanevalidatorAPIClient(self.api_key)

    @patch('apiverve_danerecordvalidator.apiClient.requests.get')
